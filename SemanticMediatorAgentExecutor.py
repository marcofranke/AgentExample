...
from SemanticMediatorAgent import SemanticMediatorAgent


class SemanticMediatorAgentExecutor(AgentExecutor):
    """Baugleich mit AdderAgentExecutor. Zusätzlich werden Netzwerkfehler als FAILED gemeldet."""

    def __init__(self) -> None:
        self.agent = SemanticMediatorAgent()
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        await updater.update_status(
            ...
            message=new_text_message("Rufe Semantischen Mediator auf..."),
        )
        ...
        try:
            ...
            await updater.update_status(
                state=TaskState.TASK_STATE_FAILED,
                message=new_text_message(f"Semantischer Mediator nicht erreichbar: {err}"),
            )
            return
