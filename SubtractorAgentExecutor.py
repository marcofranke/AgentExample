...
from SubtractorAgent import SubtractorAgent


class SubtractorAgentExecutor(AgentExecutor):
    """Baugleich mit AdderAgentExecutor, nur mit anderer 'Intelligenz' dahinter."""

    def __init__(self) -> None:
        self.agent = SubtractorAgent()
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        await updater.update_status(
            ...
            message=new_text_message("Rechne..."),
        )

        # 3. Eigentliche Arbeit erledigen – bei ungültiger Eingabe Task als fehlgeschlagen markieren
