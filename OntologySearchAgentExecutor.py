...
from OntologySearchAgent import OntologySearchAgent


class OntologySearchAgentExecutor(AgentExecutor):
    """Baugleich mit AdderAgentExecutor. Zusätzlich werden Netzwerkfehler als FAILED gemeldet."""

    def __init__(self) -> None:
        self.agent = OntologySearchAgent()
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        await updater.update_status(
            ...
            message=new_text_message("Durchsuche Ontologie-Register..."),
        )
        ...
        try:
            ...
            await updater.update_status(
                state=TaskState.TASK_STATE_FAILED,
                message=new_text_message(f"Ontologie-Register nicht erreichbar: {err}"),
            )
            return
